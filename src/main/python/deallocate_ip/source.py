...
def do_deallocate_ip(self, auth_credentials, cert):
    ...
    for deallocation in self.inputs["ipDeallocations"]:
        deallocation_result.append(deallocate(self.inputs["resourceInfo"], deallocation, ipam))
...
def deallocate(resource, deallocation, ipam):
    ...
    ipam.delete('/addresses/'+ip+'/'+ip_range_id+'/')
